...
if "%1"=="stats" (
    ...
    C:/Users/SHADOW/AppData/Local/Programs/Python/Python313/python.exe history-automate.py --stats
    pause
    exit
)
...
if "%1"=="fetch-all" (
    ...
    C:/Users/SHADOW/AppData/Local/Programs/Python/Python313/python.exe history-automate.py --fetch-all
    pause
    exit
)
